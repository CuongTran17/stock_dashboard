...
COMPANY_SOURCE = os.getenv("VNSTOCK_COMPANY_SOURCE", "vci")
...
PRELOAD_REFERENCE_SYMBOL_LIMIT = max(1, min(len(VN30_SYMBOLS), _env_int("VNSTOCK_PRELOAD_SYMBOL_LIMIT", len(VN30_SYMBOLS))))
