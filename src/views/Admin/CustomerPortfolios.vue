<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <PageHeader title="👥 Danh Mục Khách Hàng" />
    <div class="p-6">
      <div class="max-w-6xl mx-auto">
        ...
        <div v-else class="space-y-6">
          ...
          >
            <!-- User Header -->
            <div class="px-6 py-4 bg-gradient-to-r from-brand-50 to-indigo-50 dark:from-gray-750 dark:to-gray-700 flex items-center justify-between">
              <div>
            ...
            <!-- Holdings Table -->
            <table v-if="portfolio.holdings.length > 0" class="w-full">
              ...
              <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                <tr v-for="h in portfolio.holdings" :key="h.symbol" class="hover:bg-gray-50 dark:hover:bg-gray-750">
                  <td class="px-6 py-3 font-semibold text-brand-600">{{ h.symbol }}</td>
